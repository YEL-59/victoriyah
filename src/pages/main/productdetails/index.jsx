    ...
    <>
      <div className="container mx-auto bg-background py-20">
        <div className="flex flex-col gap-4">
          <h5 className="text-sm sm:text-base">Home / Cars, Vehicles & Parts /  Nissan / Nissan</h5>
          <div className="flex justify-between mb-6">
            <h2 className="text-xl sm:text-2xl lg:text-3xl leading-[132%] font-semibold tracking-[-0.48px]">2010 Nissan, QASHQAI, diesel. DAMAGED REPAIRABLE</h2>
            <h2 className="text-lg sm:text-xl lg:text-2xl leading-[132%] font-semibold tracking-[-0.48px]">$ 299.99</h2>
          </div>
              ...
              <div className='flex flex-col gap-8 sm:gap-10 lg:gap-12'>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-4'>
                    <img src={profile} alt="" />
                    <div>
                      <h3 className='text-xl sm:text-2xl lg:text-3xl font-semibold leading-[132%] tracking-[-0.48px]'>Iva Ryan</h3>
                      <p className='text-sm sm:text-base lg:text-lg leading-[164%]'>Posted 2 hours ago</p>
                    </div>
                  </div>
                  <p className='text-sm sm:text-base lg:text-lg leading-[164%] font-semibold'>See all</p>
                </div>
                <div className='bg-[#F3FFE5] border border-[#E8E8E8] p-6 flex flex-col gap-6 rounded-[24px]'>
                  <div className=' flex items-center gap-6'>
                    ...
                    <div className='flex flex-col gap-2'>
                      <h3 className='text-xl sm:text-2xl lg:text-3xl font-semibold leading-[132%] tracking-[-0.48px]'>Contact</h3>
                      <p className='text-sm sm:text-base lg:text-lg leading-[164%]'>+1 (555) 123-4567</p>
                    </div>
                  </div>
                  <div className=' flex items-center gap-6'>
                    <div className='bg-[#96E437] p-[10px] rounded-[99px] w-fit'><img src={mail} alt="icon" /></div>
                    <div className='flex flex-col gap-2'>
                      <h3 className='text-xl sm:text-2xl lg:text-3xl font-semibold leading-[132%] tracking-[-0.48px]'>Email</h3>
                      <p className='text-sm sm:text-base lg:text-lg leading-[164%]'>iva.ryan@example.com</p>
                    </div>
                  </div>
                </div>
                ...
                <div className='w-full flex flex-col gap-4'>
                  <Button className='bg-[#96E437] text-foreground px-6 sm:px-8 py-2 rounded-[24px]'>Send message</Button>
                  <Button onClick={handleNavigate} className='bg-[#FFF] text-foreground px-6 sm:px-8 py-2 rounded-[24px]'>Exchange</Button>
          ...
          <div className='flex items-start justify-between flex-col lg:flex-row w-full my-4 gap-6'>
            <div className='flex flex-col gap-4 text-[#2F2F2F]'>
              <h2 className="text-xl sm:text-2xl lg:text-3xl leading-[132%] font-semibold tracking-[-0.48px]">Description</h2>
              <div className='flex flex-col gap-1 text-[#2F2F2F]'>
                <p className='text-sm sm:text-base lg:text-lg leading-[132%] tracking-[-0.36px]'>Damaged Repairable Qashqai</p>
            ...
            <div className='bg-[#FFF] rounded-[24px] border border-[#E8E8E8] max-w-[80%] sm:max-w-[50%]'>
              <div className='flex items-center justify-between gap-8  p-8'>
                <h2 className="text-xl sm:text-2xl lg:text-3xl leading-[132%] font-semibold tracking-[-0.48px]">Share:</h2>
                <div className='flex items-center'>
                  <div className='p-[10px] rounded-[99px] border bg-[#96E437]'><img src={facebook} alt="icon" className='shrink-0 '/></div>
                  <div className='p-[10px] rounded-[99px] border bg-[#96E437]'><img src={twitch} alt="icon" className='shrink-0'/></div>
                  <div className='p-[10px] rounded-[99px] border bg-[#96E437]'><img src={copy} alt="icon" className='shrink-0'/></div>
                </div>
              </div>
            </div>
          </div>
          <div className='mt-4 lg:mt-6 xl:mt-8 mb-4 w-full'>
            <h1 className='text-2xl sm:text-3xl lg:text-[28px] xl:text-[32px] leading-[164%] tracking-[-0.32px] font-semibold mb-6'>You may also like...</h1>
