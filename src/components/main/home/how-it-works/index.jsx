    ...
    return (
        <div className='py-28 '>
            <div className='w-[90%] sm:w-[80%] lg:w-[60%] h-full mx-auto flex flex-col gap-10'>
                <h1 className='text-center text-[32px] sm:text-[40px] lg:text-[48px] font-bold leading-[132%] tracking-[-0.48px] text-foreground'>How It Works</h1>
                <div className='flex justify-between flex-wrap sm:flex-nowrap gap-6'>
                    <div className='flex flex-col gap-2 w-[90%] sm:w-[80%] lg::w-1/2'>
                        <h4 className='text-sm sm:text-base lg:text-lg leading-[170%] tracking-[-0.4px] text-[#457B10]'>Amplifying Voices, Building Trust.</h4>
                        <h1 className='w-full text-[32px] sm:text-[40px] lg:text-[48px] font-bold leading-[132%] tracking-[-0.48px] text-foreground'>Building success, one step at a time</h1>
                    </div>
                    ...
                    <div className='w-full'>
                        <div className='flex flex-col w-full h-full justify-center items-start 2xl:items-center gap-8 sm:12 lg:gap-16 relative'>
                            <div className='flex gap-6'>
                                ...
                                <div>
                                    <h1 className='text-[24px] sm:text-[32px] lg:text-[40px] font-medium leading-[130%] tracking-[-2px]'>Post Your Item</h1>
                                    <p className='text-sm sm:text-base lg:text-lg leading-[164%]'>Our team conducts comprehensive research to outline a customized strategy.</p>
                                </div>
                            </div>
                            <div className='flex gap-6'>
                                ...
                                <div>
                                    <h1 className='text-[24px] sm:text-[32px] lg:text-[40px]  font-medium leading-[130%] tracking-[-2px]'>Find a Trade</h1>
                                    <p className='text-sm sm:text-base lg:text-lg leading-[164%]'>We create user-centric, scalable solutions using cutting-edge technology.</p>
                                </div>
                            </div>
                            <div className='flex gap-6'>
                                ...
                                <div>
                                    <h1 className='text-[24px] sm:text-[32px] lg:text-[40px]  font-medium leading-[130%] tracking-[-2px]'>Make the Exchange</h1>
                                    <p className='text-sm sm:text-base lg:text-lg leading-[164%]'>We gather feedback and make continuous improvements to ensure sustained success.</p>
                                </div>
                            </div>
                            <div className='absolute z-[-1] left-[6%] top-[10%] mb-2 hidden 2xl:block'><img src={dotLine} alt="line" /></div>
                        </div>
                    </div>
                </div>
            </div>
