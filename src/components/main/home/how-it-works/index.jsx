...
function HowItWorks() {
  const { howItWorksData } = useGetHome();
  const steps = howItWorksData?.steps || [];
  return (
    <div className="py-28">
      <div className="container h-full mx-auto px-10 flex flex-col gap-10">
        <h1 className="text-center text-[18px] ] xl:text-[25px] 2xl:text-[48px] font-bold leading-[132%] tracking-[-0.48px] text-foreground">
          How It Works
        </h1>
        ...
        <div className="flex justify-between flex-wrap sm:flex-nowrap gap-6">
          <div className="flex flex-col gap-2 w-[90%] sm:w-[80%] lg:w-1/2">
            ...
            <h1 className="w-full text-[18px]  xl:text-[25px] 2xl:text-[48px] font-bold leading-[132%] tracking-[-0.48px] text-foreground">
        ...
        {/* Main Section */}
        <div className="flex justify-between xl:flex-row flex-col gap-12 lg:gap-16 2xl:gap-20 w-full">
          {/* Image Card */}
          ...
          <div className="w-full">
            <div className="flex flex-col w-full h-full justify-center items-start  gap-8 sm:12 lg:gap-8 relative">
              {steps.map((step, index) => (
                <div className="flex gap-5" key={index}>
                  <div className="bg-[#B5F169] text-foreground flex items-center justify-center py-4 px-5 rounded-full h-fit w-fit">
                    <p className="text-[28px] font-bold ">{index + 1}</p>
                  </div>
                  <div>
                    <h1 className="text-[24px] sm:text-[32px] lg:text-[40px] font-medium ">
                      {step.title}
                    </h1>
                    <p
              ...
              <div className="absolute z-[-1] left-[3%] top-[10%] mb-2 hidden 2xl:block">
